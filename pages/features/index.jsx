          ...
          <div className="row  ">
            ...
            <div className="col-md-6 text-end bbb">
              <div className={`section-img ${imageHidden ? "show " : "hide"}`}>
                <img
                  src="https://odoads.com/assets/img/preview/ipad-1.png"
                  alt="..."
                  data-aos="fade-left"
                  className="img-1"
                />
        ...
        <div className="container">
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <img
                className="img-fluid"
                src="https://odoads.com/assets/img/thumb/business-people.jpg"
                alt="watch a video"
              />
            </div>

            <div className="col-md-6">
              <ol className="step mt-1">
      ...
      <section className="section bg-gray pt-6 pb-6">
        <div className="container">
          <header className="section-header text-center my-5">
            ...
            <p className="">Limitless possibilities. What will you create?</p>
          </header>

          <div className="row gap-y text-center">
            {features.map((feature, index) => (
              <div className="col-md-6 col-lg-3 py-6" key={index}>
