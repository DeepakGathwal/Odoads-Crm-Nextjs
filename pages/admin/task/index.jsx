...
const Index = () => {
  ...
  const getAllTask = async () => {
    ...
    const process = data.filter((media) => media.status === "Processing").length;
    ...
    const Completed = data.filter((media) => media.status === "Completed").length;
          ...
          <div className="main_container">
            <div className="row">
              <div className="col-lg-12 ">
                ...
                {/* {tableview && <button type="button" className="btn btn-light switch_btn" onClick={SwitchToboard}>SWITCH TO BOARD VIEW</button>}
                 {boardview && <button type="button" className="btn btn-light switch_btn" onClick={SwitchTotable}>SWITCH TO LIST</button>} */}
              </div>
            </div>
            <hr />
            {tableview && (
              ...
              <div className="col-lg-2 margin_right">
                ...
                <MaterialTable
                  ...
                  columns={[
                    ...
                    { title: "Due Date", field: "datefinished" },
                    { title: "Assigned To", field: "assign" },
