...
import { blockkMediaApi, getMediasApi } from "../../../apis/apis";
...
const Index = () => {
  ...
  const excel = async (e) => {
    try {
      ...
      let response;
      await fetch(`http://localhost:3000/api/pbb`, {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
        },
        body: JSON.stringify({ e: docs, checkedCardData: model }),
        credentials: "include",
      })
        .then((data) => {
          response = data;
      ...
      <div className="containers">
        ...
        <div className="container-pages">
          <div className="task-panel">
            ...
            <Filters medias={medias} city={city} setFilteredMedia={setFilteredMedia} mediaCategory={mediaCategory} />
            <hr />
                  ...
                  <div className="col-md-3 my-2" key={i}>
                    <div className="card border-0 position-relative">
                      ...
                      <div className="card-body p-md-2 pb-md-3">
                        <button class="border-0" id="blocked">
                          {response.block === 1 ? (
                            <>Blocked</>
                          ) : response.booked === 0 ? (
                            <>Available</>
