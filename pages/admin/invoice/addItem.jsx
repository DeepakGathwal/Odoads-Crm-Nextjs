            ...
            <div className="filter " style={{ width: "55.5vw" }}>
              <div className="row">
                ...
                <div className="col-md-6">
                  <label className="form-label">
                    {" "}
                    <small className="req text-danger">*</small>Tax 1
                  </label>
                  <select
                    className={`select-1 ${
                ...
                <div className="col-md-6">
                  <label className="form-label">
                    {" "}
                    <small className="req text-danger">*</small>Item Group
                  </label>
                  <input
                  ...
                  />
                    {isFormSubmitted && FormData.item_group === "" && (
                    <div className="invalid-feedback">Please write item group.</div>
                  )}
                </div>
                <div className="col-md-12">
                  <label className="form-label">
                    {" "}
                    <small className="req text-danger">*</small>Unit
                  </label>
                  <select
                     className={`select-1 ${
                      isFormSubmitted && FormData.unit === "" ? "is-invalid" : ""
                    }`}
                    name="unit"
                    value={FormData.unit}
                    onChange={handleChange}
