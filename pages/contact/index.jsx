  ...
  return (
    <>
      <Head>
        ...
        <title>
        Get in touch with us to know more about OOH/DOOH Media Inventories Management Software | OdoAds
        </title>
        <meta charSet="utf-8" />
        ...
        <meta property="og:image" href="https://odoads.com/imgs/contact-bg.jpg" />
        ...
        <meta property="twitter:image" href="https://odoads.com/imgs/contact-bg.jpg" />
      ...
      >
        <div className="container pt-1">
          ...
          <div className=" text-center text-light mt-5">
            ...
            <div className="row gap-y text-center mt-5">
